  ...
  return (
    <div>
      ...
      <p>
        ...
        A plataforma visa licenciar o uso de seus, aplicativos e demais ativos de propriedade intelectual, fornecendo ferramentas para auxiliar o dia a dia dos seus usuários, com relação a busca de soluções para alergias alimentares.
        A plataforma caracteriza-se pela prestação do seguinte serviço: Inclusão e busca de receitas e produtos para pessoas com alergias alimentares diversas.
        <br /><br /><strong>2. Da aceitação</strong><br />
        ...
        <br /><br /><strong>3. Do acesso dos usuários</strong><br />
        ...
        Mediante a realização do cadastro o usuário declara e garante expressamente ser plenamente capaz, podendo exercer e usufruir livremente dos serviços e produtos. O usuário deverá fornecer um endereço de e-mail válido, através do qual o site realizará todas as comunicações necessárias.
        ...
        <br /><br /><strong>5. Do Acesso</strong><br />
        ...
        O usuário poderá, a qualquer tempo, requerer o cancelamento de seu cadastro junto ao aplicativo TH2. O seu descadastramento será realizado o mais rapidamente possível.
        ...
        <br /><br /><strong> 6. Do suporte</strong><br />
        Em caso de qualquer dúvida, sugestão ou problema com a utilização da plataforma, o usuário poderá entrar em contato com o suporte, através do telefone (11) 98573-7548. Estes serviços de atendimento ao usuário estarão disponíveis nos seguintes dias e horários: segunda à sexta das 10:00 às 18:00.
        <br /><br /><strong>7. Das responsabilidades</strong><br />
        ...
        É de responsabilidade da plataforma TH2:
        ...
        O uso da plataforma pelo usuário é pessoal, individual e intransferível, sendo vedado qualquer uso não autorizado, comercial ou não-comercial. Tais usos consistirão em violação dos direitos de propriedade intelectual da razão social TH2 Corporation, puníveis nos termos da legislação aplicável.
        <br /><br /><strong>9. Das sanções</strong><br />
        Sem prejuízo das demais medidas legais cabíveis, a razão social TH2 Corporation poderá, a qualquer momento, advertir, suspender ou cancelar a conta do usuário:
        ...
        <br /><br /><strong>10. Da rescisão</strong><br />
        A não observância das obrigações pactuadas neste Termo de Uso ou da legislação aplicável poderá, sem prévio aviso, ensejar a imediata rescisão unilateral por parte da razão social TH2 Corporation e o bloqueio de todos os serviços prestados ao usuário.
        <br /><br /><strong>11. Das alterações</strong><br />
        Os itens descritos no presente instrumento poderão sofrer alterações, unilateralmente e a qualquer tempo, por parte de TH2 Corporation, para adequar ou modificar os serviços, bem como para atender novas exigências legais. As alterações serão veiculadas pelo aplicativo TH2 e o usuário poderá optar por aceitar o novo conteúdo ou por cancelar o uso dos serviços, caso seja assinante de algum serviço.
        <br /><br /><strong>12. Da política de privacidade</strong><br />
        ...
        <br /><br /><strong> 13. Do foro</strong><br />
        Para a solução de controvérsias decorrentes do presente instrumento será aplicado integralmente o Direito brasileiro. Os eventuais litígios deverão ser apresentados no foro da comarca de São Bernardo do Campo.
      </p>
